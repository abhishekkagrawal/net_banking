	...
	<s:form action="CardDetailPageAction">
		<div class="wrapper row4">
			<div id="quicknav" class="clear">
				<ul>
					<li><a href="<s:url action="myAccountCardDetailPageAction"/>">My
							Account</a></li>
					<li><a href="<s:url action="transferCardDetailPageAction"/>">Transfer</a></li>
					<li><a
						href="<s:url action="billPaymentCardDetailPageAction"/>">Bill
							Payment</a></li>
					<li><a href="<s:url action="cardDetailCardDetailPageAction"/>">Cards
							Details</a></li>
					<li><a
						href="<s:url action="personalDetailCardDetailPageAction"/>">Personal
							Detail</a></li>
		...
		<div>
			<div class="wrapper row4">
				<div id="quicknav" class="clear">
					<ul>
						<li><a
							href="<s:url action="cardDetailCardDetailPageAction"/>">Card
								Detail</a></li>
						<li><a href="<s:url action="applyCardCardDetailPageAction"/>">Apply
								Card</a></li>
					</ul>
				</div>
			</div>
		...
		<div>
			<p>
				<b><h2 align="center">!!! See credit card information !!!</h2></b>
			</p>
		</div>
		<br />
		<s:if test="%{creditCardDetailList.size >0}">
					...
					<tbody>
						...
						<s:iterator value="creditCardDetailList" status="status">
							<tr class="tabledatatr2" height="25px">
								...
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="creditCardNumber" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="nameOnCard" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="cardTypeName" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="%{maxLimit-unbilledAmount}" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="unbilledAmount" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="maxLimit" /></td>
								<td
								...
								<td
									...
									href=#
									onclick='payCreditCardBill("<s:property value="cardId"/>", "<s:property value="nameOnCard"/>", "<s:property value="creditCardNumber"/>", "<s:property value="unbilledAmount"/>");'>Pay</a></td>
							</tr>
						</s:iterator>
					</tbody>
				</table>
			...
			<div id="showCreditDiv" align="center">
				<table>
					...
					<tr>
						<td><s:textfield name="nameOnCard" label="Name"
								id="nameOnCard" readonly="true" /></td>
					</tr>
					<tr>
						<td><s:textfield name="creditCardNumber" label="Card Number"
								id="creditCardNumber" readonly="true" /></td>
					</tr>
					<tr>
						<td><s:textfield name="unbilledAmount" label="Amount"
								id="unbilledAmount" readonly="true" /></td>
					</tr>
					<tr>
						<td><s:textfield name="remark" label="Remark" id="remark" /></td>
					</tr>
					<tr>
						<td><input type="button" value="Pay" id="payButton"
							onclick="return creditCardBillValidation();" /></td>
					</tr>
				</table>
			</div>
			<br />
			...
			<div id="transactionDiv" align="center">
				...
				<table>
					<tr>
						<td><s:textfield name="userId" id="userId"
								label="Enter user id" maxLength="10" /></td>
					</tr>
					<tr>
						<td><s:password name="transactionPassword"
								label="Enter Transaction Password" id="transactionPassword"
								maxLength="15" /></td>
					</tr>
					<tr>
						<td><s:submit id="submitId"
								onclick="return transactionValidation()" theme="simple" /></td>
						<td><input type="button" value="Cancel"
							id="creditCartCancelButton" /></td>
					</tr>
				</table>
			</div>
		</s:if>
