	...
	<s:form action="RegisteredBeneficiaryNEFTAction">
		<div class="wrapper row4">
			<div id="quicknav" class="clear">
				<ul>
					<li><a
						href="<s:url action="myAccountRegisteredBeneficiaryNEFTAction"/>">My
							Account</a></li>
					<li><a
						href="<s:url action="transferRegisteredBeneficiaryNEFTAction"/>">Transfer</a></li>
					<li><a
						href="<s:url action="billPaymentRegisteredBeneficiaryNEFTAction"/>">Bill
							Payment</a></li>
					<li><a
						href="<s:url action="cardDetailRegisteredBeneficiaryNEFTAction"/>">Cards
							Details</a></li>
					<li><a
						href="<s:url action="personalDetailRegisteredBeneficiaryNEFTAction"/>">Personal
							Detail</a></li>
		...
		<div>
			<div class="wrapper row4">
				<div id="quicknav" class="clear">
					<ul>
						<li><a
							href="<s:url action="registerBeneficaryRegisteredBeneficiaryNEFTAction"/>">Register
								Beneficiary</a></li>
						<li><a
							href="<s:url action="confirAndRejectBeneficiaryRegisteredBeneficiaryNEFTAction"/>">Confirm/Reject
								Beneficiary</a></li>
						<li><a
							href="<s:url action="newTransactionRegisteredBeneficiaryNEFTAction"/>">New
								Transaction</a></li>
						<li><a
							href="<s:url action="registeredBeneficiaryRegisteredBeneficiaryNEFTAction"/>">Registered
								Beneficiary</a></li>
					</ul>
				</div>
			</div>
		...
		<div>
			<p>
				<b><h2 align="center">!!! Registered Beneficiary !!!</h2></b>
			</p>
		</div>
		<br />
				...
				<tbody>
					...
					<s:iterator value="activeBeneficiaryList" status="status">
						<tr class="tabledatatr2" height="25px">
							<td style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
							...
							<td style="border: 1px solid #8c8c8c; border-collapse: collapse;"><input
								type="button" value="Delete" id="Reject"
