...
<body id="format" onload="window.history.forward(1);">
	...
	<s:form action="ModifyBillPageAction"
		onsubmit="return validationOnsubmit();">
		<div class="wrapper row4">
			<div id="quicknav" class="clear">
				<ul>
					<li><a href="<s:url action="myAccountModifyBillPageAction"/>">My
							Account</a></li>
					<li><a href="<s:url action="transferModifyBillPageAction"/>">Transfer</a></li>
					<li><a
						href="<s:url action="billPaymentModifyBillPageAction"/>">Bill
							Payment</a></li>
					<li><a href="<s:url action="cardDetailModifyBillPageAction"/>">Cards
							Details</a></li>
					<li><a
						href="<s:url action="personalDetailModifyBillPageAction"/>">Personal
							Detail</a></li>
			...
			<div class="wrapper row4">
				<div id="quicknav" class="clear">
					<ul>
						...
						<li><a
							href="<s:url action="modifyBillModifyBillPageAction"/>">Modify</a></li>
						<li><a href="<s:url action="payBillModifyBillPageAction"/>">Pay
								Bill</a></li>
					</ul>
				</div>
			</div>
		...
		<div>
			<p>
				<b><h2 align="center">!!! Modify your bill !!!</h2></b>
			</p>
		</div>
		<br />
		<div>
						...
						<s:iterator value="electricityBillList" status="status">
							<tr class="tabledatatr2" height="25px">
								...
								<td
									...
									href=#
									onclick='deleteElectricityBilldetail("<s:property value="electricityBillId"/>", "<s:property value="#session.userInfo.accountNumber"/>", this);'>Delete</a></td>
							</tr>
						</s:iterator>
					</tbody>
				</table>
						...
						<s:iterator value="bsnlCelloneBillList" status="status">
							<tr class="tabledatatr2" height="25px">
								...
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><a
									href=#
									onclick='deleteBSNLCelloneDetail("<s:property value="bsnlCelloneId"/>", "<s:property value="#session.userInfo.accountNumber"/>", this);'>Delete</a></td>
							</tr>
						</s:iterator>
					</tbody>
				</table>
						...
						<s:iterator value="sbiLifeInsurenceList" status="status">
							<tr class="tabledatatr2" height="25px">
								...
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><a
									href=#
									onclick='deleteSBILifeInsurenceDetail("<s:property value="sbiLifeinsurenceId"/>", "<s:property value="#session.userInfo.accountNumber"/>", this);'>Delete</a></td>
							</tr>
						</s:iterator>
					</tbody>
				</table>
