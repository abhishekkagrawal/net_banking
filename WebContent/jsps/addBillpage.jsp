	...
	<s:form action="AddBillPageAction">
		<div class="wrapper row4">
			<div id="quicknav" class="clear">
				<ul>
					<li><a href="<s:url action="myAccountAddBillPageAction"/>">My
							Account</a></li>
					<li><a href="<s:url action="transferAddBillPageAction"/>">Transfer</a></li>
					<li><a href="<s:url action="billPaymentAddBillPageAction"/>">Bill
							Payment</a></li>
					<li><a href="<s:url action="cardDetailAddBillPageAction"/>">Cards
							Details</a></li>
					<li><a
						href="<s:url action="personalDetailAddBillPageAction"/>">Personal
							Detail</a></li>
			...
			<div class="wrapper row4">
				<div id="quicknav" class="clear">
					<ul>
						...
						<li><a href="<s:url action="payBillAddBillPageAction"/>">Pay
								Bill</a></li>
					</ul>
				</div>
			</div>
		...
		<div>
			<p>
				<b><h2 align="center">!!! Add new bill !!!</h2></b>
			</p>
		</div>
		<br />
		<div align="center">
		...
		<div id="firstDiv">
			<table align='center' id="tbl1">
				<tr>
					<td><s:select label="City/State" name="state" list="stateList"
							listKey="stateId" listValue="stateName" id="state" /></td>
				</tr>
				<tr>
					<td><s:select label="Biller Name" name="biller"
							list="billerList" listKey="billerId" listValue="billerName"
							id="biller" /></td>
				</tr>
				<tr>
		...
		<div align="center" id="electricity">
			...
			<table>
				<tr>
					<td><s:textfield name="electricityNickName" label="Nick Name"
							id="electricityNickName" /></td>
				</tr>
				<tr>
					<td><s:textfield name="billingUnit" label="Billing Unit"
							id="electricityBillingUnit" /></td>
				</tr>
				<tr>
					<td><s:textfield name="processingCycle"
							label="Processing Cycle" id="electricityProcessingCycle" /></td>
				</tr>
				<tr>
					<td><s:textfield name="consumerNumber" label="Consumer Number"
							id="electricityConsumerNumber" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td><s:submit action="electricityAddBillPageAction"
							align="center" onclick="return electricityValidation();" /></td>
				</tr>
			</table>
		</div>
		<div align="center" id="bsnlCellone">
			...
			<table>
				<tr>
					<td><s:textfield name="bsnlCelloneNickName" label="Nick Name"
							id="bsnlCelloneNickName" /></td>
				</tr>
				<tr>
					<td><s:textfield name="mobilenumber" label="Mobile Number"
							id="bsnlCelloneMobileNumber" maxLength="10" /></td>
				</tr>
				<tr>
					<td>Selected Account Number:</td>
					<td><s:property value="#session.userInfo.accountNumber" /></td>
				...
				<tr>
					<td><s:submit action="bsnlCelloneAddBillPageAction"
							align="center" onclick="return bsnlCelloneValidation();" /></td>
				</tr>
			</table>
		</div>
		<div align="center" id="sbiLifeInsurence">
			...
			<table>
				<tr>
					<td><s:textfield name="sbiLifeInsurenceNickName"
							label="Nick Name" id="sbiLifeInsurenceNickName" /></td>
				</tr>
				<tr>
					<td><s:textfield name="policyNumber" label="Policy Number"
							id="sbiLifeInsurencePolicyNumber" /></td>
				</tr>
				<tr>
					<td><s:textfield name="dateOfBirth" id="dateOfBirth"
							label="Date of birth of policy holder" readonly="true" /></td>
				</tr>
				<tr>
					<td>Selected Account Number:</td>
					<td><s:property value="#session.userInfo.accountNumber" /></td>
				...
				<tr>
					<td><s:submit action="sbiLifeInsurenceAddBillPageAction"
							align="center" onclick="return sbiLifeInsurenceValidation();" /></td>
				</tr>
