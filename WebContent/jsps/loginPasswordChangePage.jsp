...
<body id="format" onload="window.history.forward(1);">
	...
	<s:form action="LoginPasswordChangePageAction"
		onsubmit="return validation();">
		<div class="wrapper row4">
			<div id="quicknav" class="clear">
				<ul>
					<li><a
						href="<s:url action="myAccountLoginPasswordChangePageAction"/>">My
							Account</a></li>
					<li><a
						href="<s:url action="transferLoginPasswordChangePageAction"/>">Transfer</a></li>
					<li><a
						href="<s:url action="billPaymentLoginPasswordChangePageAction"/>">Bill
							Payment</a></li>
					<li><a
						href="<s:url action="cardDetailLoginPasswordChangePageAction"/>">Cards
							Details</a></li>
					<li><a
						href="<s:url action="personalDetailLoginPasswordChangePageAction"/>">Personal
							Detail</a></li>
		...
		<div>
			<div class="wrapper row4">
				<div id="quicknav" class="clear">
					<ul>
						<li><a
							href="<s:url action="myProfileLoginPasswordChangePageAction"/>">My
								Profile</a></li>
						<li><a
							href="<s:url action="changeLoginPasswordLoginPasswordChangePageAction"/>">Change
								Login password</a></li>
						<li><a
							href="<s:url action="changeTransactionPasswordLoginPasswordChangePageAction"/>">Change
		...
		<div>
			<p>
				<b><h2 align="center">!!! Change Your Login Password !!!</h2></b>
			</p>
		</div>
		<div align="center">
			<s:actionerror />
		...
		<div>
			<div align="justify" height="50" width="25">
				<p style="font-family: arial; color: red; font-size: 20px;">
					The password policy is:<br /> 1.At least 8 chars<br /> 2.Contains
					at least one digit<br /> 3.Contains combination of number and char<br />
					4.Contains first character must be alphabets <br /> 5.Not
					containing blank,tab etc.<br /> 6.Password should not be current or
					old password.<br />
				</p>
			</div>
				...
				<table align="center">
					<tr>
						<td><p class="myprofiletd1">
								<b>Change Login Password</b>
							</p></td>
					</tr>
					<br>
					<tr>
						<td><s:password name="oldLoginPassword" label="Old Password"
								id="oldLoginPassword" maxLength="10" /></td>
					</tr>
					<tr></tr>
					<tr>
						<td><s:password name="newLoginPassword" label="New Password"
								id="newLoginPassword" maxLength="15" /></td>
					</tr>
					<tr></tr>
					<tr>
						<td><s:password name="conformNewLoginPassword"
								label="Confirm Password" id="conformNewLoginPassword"
								maxLength="15" /></td>
					</tr>
					<tr></tr>
					<tr>
						...
						<td><a
							href="<s:url action="personalDetailLoginPasswordChangePageAction"/>">Back</a></td>
					</tr>
