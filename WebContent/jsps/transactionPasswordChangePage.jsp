...
<body id="format" onload="window.history.forward(1);">
	...
	<s:form action="TransactionPasswordChangePageAction"
		onsubmit="return validation();">
		<div class="wrapper row4">
			<div id="quicknav" class="clear">
				<ul>
					<li><a
						href="<s:url action="myAccountTransactionPasswordChangePageAction"/>">My
							Account</a></li>
					<li><a
						href="<s:url action="transferTransactionPasswordChangePageAction"/>">Transfer</a></li>
					<li><a
						href="<s:url action="billPaymentTransactionPasswordChangePageAction"/>">Bill
							Payment</a></li>
					<li><a
						href="<s:url action="cardDetailTransactionPasswordChangePageAction"/>">Cards
							Details</a></li>
					<li><a
						href="<s:url action="personalDetailTransactionPasswordChangePageAction"/>">Personal
							Detail</a></li>
		...
		<div>
			<div class="wrapper row4">
				<div id="quicknav" class="clear">
					<ul>
						<li><a
							href="<s:url action="myProfileTransactionPasswordChangePageAction"/>">My
								Profile</a></li>
						<li><a
							href="<s:url action="changeLoginPasswordTransactionPasswordChangePageAction"/>">Change
								Login password</a></li>
						<li><a
							href="<s:url action="changeTransactionPasswordTransactionPasswordChangePageAction"/>">Change
								Transaction password</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div>
			<p>
				<b><h2 align="center">!!! Change Your Transaction Password
						!!!</h2></b>
			</p>
		</div>
		<br />
		<div align="justify" height="50" width="25">
			<p style="font-family: arial; color: red; font-size: 20px;">
				The password policy is:<br /> 1.At least 8 chars<br /> 2.Contains at
				least one digit<br /> 3.Contains combination of number and char<br />
				4.Contains first character must be alphabets <br /> 5.Not containing
				blank,tab etc.<br /> 6.Password should not be current or old
				password.<br />
			</p>
		</div>
		<div align="center">
		...
		<div style="text-align: center;">
			<table align="center">
				...
				<tr>
					<td><p class="myprofiletd1">
							<b>Change Transaction Password</b>
						</p></td>
				</tr>
				<br />
				<tr>
					<td><s:password name="oldTransactionPassword"
							label="Old Password" id="oldTransactionPassword" maxLength="15" /></td>
				</tr>
				<tr>
					<td><s:password name="newTransactionPassword"
							label="New Password" id="newTransactionPassword" maxLength="15" /></td>
				</tr>
				<br />
				<tr>
					<td><s:password name="conformNewTransactionPassword"
							label="Confirm Password" id="conformNewTransactionPassword"
							maxLength="15" /></td>
				</tr>
				<tr>
					<td><p></p></td>
				...
				<tr>
					...
					<td align="center"><a
						href="<s:url action="personalDetailTransactionPasswordChangePageAction"/>">Back</a></td>
				</tr>
			</table>
		</div>
	</s:form>
