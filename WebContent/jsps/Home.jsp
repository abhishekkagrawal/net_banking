	...
	<s:form action="homeAction">
		<div class="wrapper row4">
			<div id="quicknav" class="clear">
				<ul>
					<li><a href="<s:url action="myAccountHomeAction"/>">My
							Account</a></li>
					<li><a href="<s:url action="transferHomeAction"/>">Transfer</a></li>
					<li><a href="<s:url action="billPaymentHomeAction"/>">Bill
							Payment</a></li>
					<li><a href="<s:url action="cardDetailHomeAction"/>">Cards
							Details</a></li>
		...
		<div style="background-image: url(../header/images/bg.jpg)">
			...
			<div id="summaryDiv">
				...
				<table align="center" border='1'>
					<div>
						<p>
							<b><h2 align="center">!!! Welcome to home page !!!</h2></b>
						</p>
					</div>
					<tr>
						<td><b align="center">OverView</b></td>
					</tr>
					<tr>
					...
					<tr>
						<td align="center"><s:property
								value="#session.loginInfo.userId" /></td>
						<td align="center"><s:property
								value="#session.userInfo.accountType" /></td>
						<td align="center"><a
							href="<s:url action="getTransactionHomeAction"/>" onclick=""
							id="accountNumber"><s:property
									value="#session.userInfo.accountNumber" /></a></td>
						<td align="center">INR</td>
						<td align="center"><s:property
								value="#session.userInfo.availBalance" /></td>
					</tr>
				</table>
			</div>
		</div>
