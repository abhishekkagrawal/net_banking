	...
	<s:form action="ConfirmAndRejectBeneficiaryNEFTAction">
		<div class="wrapper row4">
			<div id="quicknav" class="clear">
				<ul>
					<li><a
						href="<s:url action="myAccountConfirmAndRejectBeneficiaryNEFTAction"/>">My
							Account</a></li>
					<li><a
						href="<s:url action="transferConfirmAndRejectBeneficiaryNEFTAction"/>">Transfer</a></li>
					<li><a
						href="<s:url action="billPaymentConfirmAndRejectBeneficiaryNEFTAction"/>">Bill
							Payment</a></li>
					<li><a
						href="<s:url action="cardDetailConfirmAndRejectBeneficiaryNEFTAction"/>">Cards
							Details</a></li>
					<li><a
						href="<s:url action="personalDetailConfirmAndRejectBeneficiaryNEFTAction"/>">Personal
							Detail</a></li>
		...
		<div>
			<div class="wrapper row4">
				<div id="quicknav" class="clear">
					<ul>
						<li><a
							href="<s:url action="registerBeneficaryConfirmAndRejectBeneficiaryNEFTAction"/>">Register
								Beneficiary</a></li>
						<li><a
							href="<s:url action="confirAndRejectBeneficiaryConfirmAndRejectBeneficiaryNEFTAction"/>">Confirm/Reject
								Beneficiary</a></li>
						<li><a
							href="<s:url action="newTransactionConfirmAndRejectBeneficiaryNEFTAction"/>">New
								Transaction</a></li>
						<li><a
							href="<s:url action="registeredBeneficiaryConfirmAndRejectBeneficiaryNEFTAction"/>">Registered
								Beneficiary</a></li>
					</ul>
				</div>
			</div>
		...
		<div>
			<p>
				<b><h2 align="center">!!! Confirm and delete your
						beneficiary !!!</h2></b>
			</p>
		</div>
		<div align="center">
		...
		<s:if test="%{deactiveBeneficiaryList.size >0}">
					...
					<tbody>
						...
						<s:iterator value="deactiveBeneficiaryList" status="status">
							<tr class="tabledatatr2" height="25px">
								...
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="beneficiaryAccountNumber" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="dateOfCreation" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><input
									type="button" value="Validate" id="validate"
									onclick="showBeneficiary('<s:property value="beneficiaryId"/>', '<s:property value="beneficiaryName"/>', '<s:property value="beneficiaryAccountNumber"/>', '<s:property value="dateOfCreation"/>')" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><input
									type="button" value="Delete" id="delete"
									onclick='deleteBeneficiary("<s:property value="beneficiaryId"/>", "<s:property value="#session.userInfo.accountNumber"/>", this)' /></td>
							</tr>
						</s:iterator>
						<tr>
							<td><a
								href="<s:url action="transferConfirmAndRejectBeneficiaryNEFTAction" />"
								align="center">Cancel</a></td>
						</tr>
					</tbody>
				</table>
			...
			<div id="confDiv">
				...
				<div align='center'>
					<br> <br>
					<s:textfield name="URNNumber" id="URNNumber"
						label="Enter URN Number" maxLength="8" />
					<br> <br>
					<s:submit value="Confirm Beneficiary" align="center" />
					<br> <input type="button" value="Back" id="back" />
				</div>
			</div>
		</s:if>
		<s:else>
