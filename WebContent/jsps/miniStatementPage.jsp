		...
		<s:form action="MiniStatementPageAction">
			<div class="wrapper row4">
				<div id="quicknav" class="clear">
					<ul>
						<li><a
							href="<s:url action="myAccountMinistatementPageAction"/>">My
								Account</a></li>
						<li><a
							href="<s:url action="transferMinistatementPageAction"/>">Transfer</a></li>
						<li><a
							href="<s:url action="billPaymentMinistatementPageAction"/>">Bill
								Payment</a></li>
						<li><a
							href="<s:url action="cardDetailMinistatementPageAction"/>">Cards
								Details</a></li>
						<li><a
							href="<s:url action="personalDetailMinistatementPageAction"/>">Personal
								Detail</a></li>
			...
			<div>
					...
					<div class="wrapper row4">
						<div id="quicknav" class="clear">
							<ul>
								...
								<li><a
									href="<s:url action="viewaAndSaveStatementMinistatementPageAction"/>">View/Save
										Statement</a></li>
								<li><a
									href="<s:url action="accountDetailMinistatementPageAction"/>">Account
										Detail</a></li>
							</ul>
						</div>
					</div>
				...
				<div id="firstDiv">
					...
					<table border="1" align="center" id="table2">
						...
						<s:iterator value="transactionDeatailList" var="transactionDetail"
							status="status">
							<tr>
					...
					<div align="center" id="btnDiv">
						<s:submit action="saveAccountDetailPageAction" value="Save"
							align="center" theme="simple" onclick="showPath()" />
						<s:submit action="backAccountDetailPageAction" value="Back"
				...
				<div id="secondDiv" align="center">
					...
					<table align="center" border="1">
						...
						<tr>
							<td><input type="button" id="show" value="Back to statement" />
							</td>
						</tr>
					</table>
				</div>
