...
<body id="format" onload="window.history.forward(1);">
	...
	<s:form action="NewTransactionNEFTAction"
		onsubmit="return validationOnsubmit();">
		<div class="wrapper row4">
			<div id="quicknav" class="clear">
				<ul>
					<li><a
						href="<s:url action="myAccountNewTransactionNEFTAction"/>">My
							Account</a></li>
					<li><a
						href="<s:url action="transferNewTransactionNEFTAction"/>">Transfer</a></li>
					<li><a
						href="<s:url action="billPaymentNewTransactionNEFTAction"/>">Bill
							Payment</a></li>
					<li><a
						href="<s:url action="cardDetailNewTransactionNEFTAction"/>">Cards
							Details</a></li>
					<li><a
						href="<s:url action="personalDetailNewTransactionNEFTAction"/>">Personal
							Detail</a></li>
		...
		<div>
			<div class="wrapper row4">
				<div id="quicknav" class="clear">
					<ul>
						<li><a
							href="<s:url action="registerBeneficaryNewTransactionNEFTAction"/>">Register
								Beneficiary</a></li>
						<li><a
							href="<s:url action="confirAndRejectBeneficiaryNewTransactionNEFTAction"/>">Confirm/Reject
								Beneficiary</a></li>
						<li><a
							href="<s:url action="newTransactionNewTransactionNEFTAction"/>">New
								Transaction</a></li>
						<li><a
							href="<s:url action="registeredBeneficiaryNewTransactionNEFTAction"/>">Registered
								Beneficiary</a></li>
					</ul>
				</div>
			</div>
		...
		<div>
			<p>
				<b><h2 align="center">!!! Transfer your money !!!</h2></b>
			</p>
		</div>
		<s:if test="%{activeBeneficiaryList.size >0}">
			<div id="firstDiv">
				<table align='center' id="tbl1">
					<tr>
						<td><s:select label="Transfer To" name="transferAccount"
								list="activeBeneficiaryList" listKey="beneficiaryId"
								listValue="(beneficiaryAccountNumber)+'  '+(beneficiaryName)"
								id="transferTo" /></td>
					</tr>
					<tr>
						<td><s:textfield name="transactionAmount" label="Amount"
								id="amount" /></td>
					</tr>
					<tr>
						<td><s:textfield name="accountNumber"
								value="%{session.userInfo.name}-%{session.userInfo.accountNumber}"
								readonly="true" label="Debit Account" id="accountDetail" /></td>
					</tr>
					<tr>
						<td><s:textfield name="particulars" label="Transfer remark"
								id="remark" /></td>
					</tr>
					<tr>
						<td><input type="button" id="btn" value="Submit"
							onclick="return  validation();" /></td>
						<td><a
							href="<s:url action="transferNewTransactionNEFTAction"/>"><input
			...
			<div id="secondDiv" align='center'>
				...
				<div align='center'>
					<table id="tbl3">
						<tr>
							<td><s:textfield name="userId" label="Enter User Id"
									id="userId" maxLength="10" /></td>
						</tr>
						<tr>
							<td><s:password name="transactionPassword"
									label="Enter Your Transaction Password"
									id="newTransactionPassword" maxLength="15" /></td>
						</tr>
						<tr>
		...
		<s:else>
			<div align="cetner">
				<h3>
					<b>No beneficiary is added first add beneficiary </b>
				</h3>
			</div>
		</s:else>
	</s:form>
