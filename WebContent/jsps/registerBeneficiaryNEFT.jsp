...
<body id="format" onload="window.history.forward(1);">
	...
	<s:form action="RegisterBeneficiaryNEFTAction"
		onsubmit="return validation();">
		<div class="wrapper row4">
			<div id="quicknav" class="clear">
				<ul>
					<li><a
						href="<s:url action="myAccountRegisterBeneficiaryNEFTAction"/>">My
							Account</a></li>
					<li><a
						href="<s:url action="transferRegisterBeneficiaryNEFTAction"/>">Transfer</a></li>
					<li><a
						href="<s:url action="billPaymentRegisterBeneficiaryNEFTAction"/>">Bill
							Payment</a></li>
					<li><a
						href="<s:url action="cardDetailRegisterBeneficiaryNEFTAction"/>">Cards
							Details</a></li>
					<li><a
						href="<s:url action="personalDetailRegisterBeneficiaryNEFTAction"/>">Personal
							Detail</a></li>
		...
		<div>
			<div class="wrapper row4">
				<div id="quicknav" class="clear">
					<ul>
						<li><a
							href="<s:url action="registerBeneficaryRegisterBeneficiaryNEFTAction"/>">Register
								Beneficiary</a></li>
						<li><a
							href="<s:url action="confirAndRejectBeneficiaryRegisterBeneficiaryNEFTAction"/>">Confirm/Reject
								Beneficiary</a></li>
						<li><a
							href="<s:url action="newTransactionRegisterBeneficiaryNEFTAction"/>">New
								Transaction</a></li>
						<li><a
							href="<s:url action="registeredBeneficiaryRegisterBeneficiaryNEFTAction"/>">Registered
								Beneficiary</a></li>
					</ul>
				</div>
			</div>
		...
		<div>
			<p>
				<b><h2 align="center">!!! Add new beneficiary !!!</h2></b>
			</p>
		</div>
		<table align="center">
			<s:hidden name="transactionType" value="NEFT" />
			<tr>
				<td><s:textfield name="beneficiaryName"
						label=" Beneficiary Name" id="beneficiaryName" maxLength="20" /></td>
			</tr>
			<tr />
			<tr>
				<td><s:select list="bankList" listValue="bankName"
						listKey="bankName" name="beneficiaryBankName" label="Bank Name" /></td>
			</tr>
			<tr />
			<tr>
				<td><s:textfield name="IFSCCode" label="NEFT IFSC Code"
						id="IFSCCode" maxLength="15" /></td>
			</tr>
			<tr />
			<tr>
				<td><s:textfield name="beneficiaryAccountNumber"
						label="Account Number" id="beneficiaryAccountNumber"
						maxLength="20" /></td>
			</tr>
			<tr>
				<td><s:textfield name="reEnterAccuontNumber"
						label="Re Enter Account Number" id="reEnterAccuontNumber"
						maxLength="20" /></td>
			</tr>
			<tr />
			<tr>
				<td><s:select name="beneficiaryAccountType"
						label="Account Type" list="{'SAVING','CURRENT'}" /></td>
			</tr>
			<tr />
			<tr>
				<td align="center"><s:submit align="center" theme="simple" /></td>
				<td align="center"><a
					href="<s:url action="backRegisterBeneficiaryNEFTAction"/>">Back</a></td>
			</tr>
		</table>
		<br>
		<br>
