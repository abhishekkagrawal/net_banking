	...
	<s:form action="ApplyCreditCardAction">
		<div class="wrapper row4">
			<div id="quicknav" class="clear">
				<ul>
					<li><a href="<s:url action="myAccountApplyCreditCardAction"/>">My
							Account</a></li>
					<li><a href="<s:url action="transferApplyCreditCardAction"/>">Transfer</a></li>
					<li><a
						href="<s:url action="billPaymentApplyCreditCardAction"/>">Bill
							Payment</a></li>
					<li><a
						href="<s:url action="cardDetailApplyCreditCardAction"/>">Cards
							Details</a></li>
					<li><a
						href="<s:url action="personalDetailApplyCreditCardAction"/>">Personal
							Detail</a></li>
		...
		<div>
			<div class="wrapper row4">
				<div id="quicknav" class="clear">
					<ul>
						<li><a
							href="<s:url action="cardDetailApplyCreditCardAction"/>">Card
								Detail</a></li>
						<li><a
							href="<s:url action="applyCardApplyCreditCardAction"/>">Apply
								Card</a></li>
					</ul>
				</div>
			</div>
		...
		<div>
			<p>
				<b><h2 align="center">!!! Apply new credit card online !!!</h2></b>
			</p>
		</div>
		<s:if test="#session.userInfo.noOfCardIssue > 0">
			<div align="center">
				<table align="center">
					<tr></tr>
					<tr>
						<td><s:select list="cardTypeList" name="cardTpe"
								label="Select Card Type" listKey="creditCardId"
								listValue="cardTypeName" id="cardName" onchange="getMaxLimit();" /></td>
					</tr>
					<tr>
						<td></td>
					</tr>
					<tr>
						<td><s:textfield name="maxLimit" label="Max Limit"
								id="maxLimit" readonly="true" /></td>
					</tr>
					<tr>
						<td></td>
					</tr>
					<tr>
						<td><s:textfield name="nameOnCard" label="Name On Card"
								id="nameOnCard" maxLength="15" /></td>
					</tr>
					<tr>
						<td></td>
					</tr>
					<tr>
						<td align="right"><s:submit value="Apply" theme="simple"
