...
<script type="text/javascript"
	src="../javascript/jquery-s3slider.setup.js"></script>
	...
	<s:form action="homeAction">
		<div class="wrapper row4">
			<div id="quicknav" class="clear">
				<ul>
					<li><a
						href="<s:url action="myAccountAccountDetailPageAction"/>">My
							Account</a></li>
					<li><a
						href="<s:url action="transferAccountDetailPageAction"/>">Transfer</a></li>
					<li><a
						href="<s:url action="billPaymentAccountDetailPageAction"/>">Bill
							Payment</a></li>
					<li><a
						href="<s:url action="cardDetailAccountDetailPageAction"/>">Cards
							Details</a></li>
					<li><a href="<s:url action="personalDetailHomeAction"/>">Personal
							Detail</a></li>
		...
		<div style="background-image: url(../header/images/bg.jpg)">
			...
			<div class="wrapper row4">
				<div id="quicknav" class="clear">
					<ul>
						<li><a
							href="<s:url action="miniStatementAccountDetailPageAction"/>">Mini
								Statement</a></li>
						<li><a
							href="<s:url action="viewAndSaveAccountDetailPageAction"/>">View/Save
								Statement</a></li>
