	...
	<s:form action="PersonalDetailPageAction">
		<div class="wrapper row4">
			<div id="quicknav" class="clear">
				<ul>
					<li><a
						href="<s:url action="myAccountPersonalDetailPageAction"/>">My
							Account</a></li>
					<li><a
						href="<s:url action="transferPersonalDetailPageAction"/>">Transfer</a></li>
					<li><a
						href="<s:url action="billPaymentPersonalDetailPageAction"/>">Bill
							Payment</a></li>
					<li><a
						href="<s:url action="cardDetailPersonalDetailPageAction"/>">Cards
							Details</a></li>
					<li><a
						href="<s:url action="personalDetailPersonalDetailPageAction"/>">Personal
							Detail</a></li>
					...
					<tr class="tabledatatr3">
						<td height="45" bgcolor="#faf6f5" align="left"
							...
							<br> <b> <a class="whiteText"
								href="<s:url action="myProfilePersonalDetailPageAction"/>">
									<font color="#8c062f">My Profile</font>
							</a>
						</b> <br> See Your Personal Detail <br>
						</td>
					</tr>
				</tbody>
			</table>
				...
				<tbody>
					<tr class="tabledatatr3">
						<td height="45" bgcolor="#faf6f5" align="left"
							style="border: 1px solid #cfc5aa; border-collapse: collapse;">
							<br> <b> <a class="whiteText"
								href="<s:url action="changeLoginPasswordPersonalDetailPageAction"/>">
									<font color="#8c062f">Change Login Password</font>
							</a>
						</b> <br> Change Your Login Password. <br>
						</td>
					</tr>
				</tbody>
			</table>
				...
				<tbody>
					<tr class="tabledatatr3">
						<td height="45" bgcolor="#faf6f5" align="left"
							style="border: 1px solid #cfc5aa; border-collapse: collapse;">
							<br> <b> <a class="whiteText"
								href="<s:url action="changeTransactionPasswordPersonalDetailPageAction"/>">
									<font color="#8c062f">Change txn Password</font>
							</a>
						</b> <br> Change Your Transaction Password. <br>
						</td>
					</tr>
				</tbody>
			</table>
