	...
	<s:form action="PayBillPageAction">
		<div class="wrapper row4">
			<div id="quicknav" class="clear">
				<ul>
					<li><a href="<s:url action="myAccountPayBillPageAction"/>">My
							Account</a></li>
					<li><a href="<s:url action="transferPayBillPageAction"/>">Transfer</a></li>
					<li><a href="<s:url action="billPaymentPayBillPageAction"/>">Bill
							Payment</a></li>
					<li><a href="<s:url action="cardDetailPayBillPageAction"/>">Cards
							Details</a></li>
					<li><a
						href="<s:url action="personalDetailPayBillPageAction"/>">Personal
							Detail</a></li>
			...
			<div class="wrapper row4">
				<div id="quicknav" class="clear">
					<ul>
						...
						<li><a href="<s:url action="payBillPayBillPageAction"/>">Pay
								Bill</a></li>
					</ul>
				</div>
			</div>
		...
		<div>
			<p>
				<b><h2 align="center">!!! Pay your bill !!!</h2></b>
			</p>
		</div>
		<br />
		<s:if test="%{electricityBillList.size >0}">
					...
					<tbody>
						...
						<s:iterator value="electricityBillList" status="status">
							<tr class="tabledatatr2" height="25px">
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="%{#status.count}" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="electricityBillId" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;">
									<s:property value="nickName" />
								</td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="billingUnit" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="processingCycle" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="consumerNumber" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="stateName" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="dateOfCreation" /></td>
								<s:if test="%{ paidStatus== true  }">
									<td>Paid</td>
								</s:if>
								<s:else>
									<td
										style="border: 1px solid #8c8c8c; border-collapse: collapse;"><a
										href=#
										onclick='payElectricityBill("<s:property value="electricityBillId"/>", "<s:property value="nickName"/>", "<s:property value="billingUnit"/>", "<s:property value="processingCycle"/>", "<s:property value="consumerNumber"/>", "<s:property value="amount"/>");'>Pay</a></td>
								</s:else>
							</tr>
						</s:iterator>
					</tbody>
			...
			<div id="electricityBill" align="center">
				<table>
					<tr>
						<td><s:hidden name="electricityBillId" value=""
								id="electricityBillId" /></td>
					</tr>
					<tr>
						<td><s:textfield name="electricityBillName" label="Name"
								readonly="true" id="electricityBillNickName" /></td>
					</tr>
					<tr>
						<td><s:textfield name="billingUnit" label="Billing Unit"
								readonly="true" id="billingUnit" /></td>
					</tr>
					<tr>
						<td><s:textfield name="processingCycle"
								label="Processing Cycle" readonly="true" id="processingCycle" /></td>
					</tr>
					<tr>
						<td><s:textfield name="consumerNumber"
								label="Consumer Number" readonly="true" id="consumerNumber" /></td>
					</tr>
					<tr>
						<td><s:textfield name="electricityBillAmount" label="Amount"
								id="electricityBillAmount" readonly="true" /></td>
					</tr>
					<tr>
						<td><s:textfield name="electricityBillRemark" label="Remark"
								id="electricityBillRemark" /></td>
					</tr>
					<tr>
						<td><input type="button" value="Pay"
							id="electricityBillPayButton"
							onclick="return electricityBillValidation();" /></td>
					</tr>
				</table>
			</div>
			<br />
			<div id="electricityTransactionDiv" align="center">
				...
				<table>
					<tr>
						<td><s:textfield name="electricityBillUserId"
								id="electricityBillUserId" label="Enter user id" /></td>
					</tr>
					<tr>
						<td><s:password name="electricityBillTransactionPassword"
								label="Enter Transaction Password"
								id="electricityBillTransactionPassword" /></td>
					</tr>
					<tr>
						<td><s:submit id="submitId"
								action="payElectricityBillPayBillPageAction"
								onclick="return electricityBillTransactionValidation()"
								theme="simple" /></td>
						<td><input type="button" value="Cancel"
							id="electricityTransactionCancelButton" /></td>
					</tr>
				</table>
			</div>
		</s:if>
		...
		<s:if test="%{bsnlCelloneBillList.size >0}">
							...
							<tr class="tabledatatr2" height="25px">
								...
								<s:else>
									<td
										style="border: 1px solid #8c8c8c; border-collapse: collapse;"><a
										href=#
										onclick='payBSNLCelloneBill("<s:property value="bsnlCelloneId"/>", "<s:property value="nickName"/>", "<s:property value="mobileNumber"/>", "<s:property value="amount"/>");'>Pay</a></td>
								</s:else>
							</tr>
						</s:iterator>
					</tbody>
			...
			<div id="bsnlCelloneBill" align="center">
				<table>
					<tr>
						<td><s:hidden name="bsnlCelloneBillId" value=""
								id="bsnlCelloneId" /></td>
					</tr>
					<tr>
						<td><s:textfield name="bsnlCelloneBillName" label="Name"
								id="bsnlCelloneBillNickName" readonly="true" /></td>
					</tr>
					<tr>
						<td><s:textfield name="mobileNumber" label="Mobile Number"
								id="mobileNumber" readonly="true" /></td>
					</tr>
					<tr>
						<td><s:textfield name="bsnlCelloneBillAmount" label="Amount"
								id="bsnlCelloneBillAmount" readonly="true" /></td>
					</tr>
					<tr>
						<td><s:textfield name="bsnlCelloneBillRemark" label="Remark"
								id="bsnlCelloneBillRemark" /></td>
					</tr>
					<tr>
						<td><input type="button" value="Pay"
							id="BSNLCellonePayButton"
							onclick="return bsnlCelloneBillValidation();" /></td>
					</tr>
				</table>
			</div>
			<br />
			<div id="BSNLTransactionDiv" align="center">
				...
				<table>
					<tr>
						<td><s:textfield name="BSNLCelloneUserId"
								id="BSNLCelloneUserId" label="Enter user id" /></td>
					</tr>
					<tr>
						<td><s:password name="BSNLCelloneTransactionPassword"
								label="Enter Transaction Password"
								id="BSNLCelloneTransactionPassword" /></td>
					</tr>
					<tr>
						<td><s:submit id="submitId"
								action="payBSNLCelloneBillPayBillPageAction"
								onclick="return BSNLCelloneTransactionValidation()" /></td>
						<td><input type="button" value="Cancel"
							id="BSNLTransactionCancelButton" /></td>
					</tr>
				</table>
			</div>
		</s:if>
		...
		<s:if test="%{sbiLifeInsurenceList.size >0}">
			<div>
				<p>
				<h3>SBI Life Insurence Bill Detail</h3>
				</p>
				<table width="80%" cellspacing="0" cellpadding="0" border="1"
					align="center">
					<tbody>
						...
						<s:iterator value="sbiLifeInsurenceList" status="status">
							<tr class="tabledatatr2" height="25px">
								...
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="policynumber" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="dobOfpolicyHolder" /></td>
								<td
									style="border: 1px solid #8c8c8c; border-collapse: collapse;"><s:property
										value="stateName" /></td>
								<td
								...
								<s:else>
									<td
										style="border: 1px solid #8c8c8c; border-collapse: collapse;"><a
										href=#
										onclick='paySBILifeInsurenceBill("<s:property value="sbiLifeinsurenceId"/>", "<s:property value="nickName"/>", "<s:property value="policynumber"/>", "<s:property value="dobOfpolicyHolder"/>", "<s:property value="amount"/>");'>Pay</a></td>
								</s:else>
							</tr>
						</s:iterator>
					</tbody>
			...
			<div id="sbiLifeInsurenceBill" align="center">
				<table>
					<tr>
						<td><s:hidden name="sbiLifeInsurenceBillId" value=""
								id="sbiLifeinsurenceId" /></td>
					</tr>
					<tr>
						<td><s:textfield name="sbiLifeInsurenceBillName" label="Name"
								id="sbiLifeInsurenceBillNickName" readonly="true" /></td>
					</tr>
					<tr>
						<td><s:textfield name="policyNumber" label="Policy Number"
								id="policynumber" readonly="true" /></td>
					</tr>
					<tr>
						<td><s:textfield name="dobOfPolicyHolder"
								label="Date of Birth" id="dobOfpolicyHolder" readonly="true" /></td>
					</tr>
					<tr>
						<td><s:textfield name="sbiLifeInsurenceBillAmount"
								label="Amount" id="sbiLifeInsurenceBillAmount" readonly="true" /></td>
					</tr>
					<tr>
						<td><s:textfield name="sbiLifeInsurenceBillRemark"
								label="Remark" id="sbiLifeInsurenceBillRemark" /></td>
					</tr>
					<tr>
						<td><input type="button" value="Pay"
							id="SBILifeInsurencePayButton"
							onclick="return sbiLifeInsurenceBillValidation();" /></td>
					</tr>
				</table>
			</div>
			<br />
			<div id="SBITransactionDiv" align="center">
				...
				<table>
					<tr>
						<td><s:textfield name="SBILifeUserId" id="SBILifeUserId"
								label="Enter user id" /></td>
					</tr>
					<tr>
						<td><s:password name="SBILifeTransactionPassword"
								label="Enter Transaction Password"
								id="SBILifeTransactionPassword" /></td>
					</tr>
					<tr>
						<td><s:submit id="submitId"
								action="paySBILifeInsurenceBillPayBillPageAction"
								onclick="return SBILifeInsurenceTransactionValidation();" /></td>
						<td><input type="button" value="Cancel"
							id="SBITransactionCancelButton" /></td>
					</tr>
				</table>
			</div>
		</s:if>
		<s:if
			test="%{electricityBillList.size <=0 && bsnlCelloneBillList.size <=0 && sbiLifeInsurenceList.size <=0}">
