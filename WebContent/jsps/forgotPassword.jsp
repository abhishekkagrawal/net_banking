...
<body>
	...
	<div align='center'
		...
		<br>
		<br>
		<s:form action="ForgotUserIdAction"
			onsubmit="return forgotPasswordValidation()">
			<h3>Enter your User Id to receive one time password (OTP) on
				your registered EmailId</h3>
			<div>
				<s:actionerror />
			</div>
			<table align="center">
				<tr>
					<td><s:textfield name="userId" label="Enter User Id"
							...
							onblur="return forgotPasswordValidateUserId()" maxLength="10" /></td>
				</tr>
				<tr>
