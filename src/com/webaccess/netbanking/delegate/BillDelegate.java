...
public class BillDelegate {
	...
	public String payElectricityBill(ElectricityBillBean electricityBillBean,
		...
		return dao.payElectricityBill(electricityBillBean, loginInfoBean,
				BillRemark);
	...
	public String payBSNLCelloneBill(BSNLCelloneBillBean bSNLCelloneBillBean,
			LoginInfoBean loginInfoBean, String BillRemark) {
		return dao.payBSNLCelloneBill(bSNLCelloneBillBean, loginInfoBean,
				BillRemark);

	}

	public String paySBILifeInsurenceBill(
			SBILifeInsurenceBean bILifeInsurenceBean,
			LoginInfoBean loginInfoBean, String BillRemark) {
		return dao.paySBILifeInsurenceBill(bILifeInsurenceBean, loginInfoBean,
				BillRemark);
	}
}
