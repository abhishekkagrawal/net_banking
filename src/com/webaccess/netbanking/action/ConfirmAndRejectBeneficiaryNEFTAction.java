 ...
 * @author Jay Prakash
 */
public class ConfirmAndRejectBeneficiaryNEFTAction extends ActionSupport
	...
	// forwarding to confirm and reject beneficiary page with deactive
	// beneficiary list for validate beneficiary
	public String confirAndRejectBeneficiary() {
		...
		if (loginInfoBean == null) {
			...
			deactiveBeneficiaryList = beneficiaryDelegate
					.getDeactiveBeneficiary(accountNumber, transactionType);
	...
	public String newTransaction() {
		...
		if (loginInfoBean == null) {
			...
			int accountNumber = loginInfoBean.getAccountNumber();
			String transactionType = "NEFT";
			activeBeneficiaryList = beneficiaryDelegate.getActiveBeneficiary(
	...
	public String execute() {
		...
		if (loginInfoBean == null) {
			...
			int accountNumber = loginInfoBean.getAccountNumber();
			result = beneficiaryDelegate.confirmBeneficiary(accountNumber,
					beneficiaryId, URNNumber);
			if (result) {
				return "transfer";
			} else {
				// int accountNumber = loginInfoBean.getAccountNumber();
