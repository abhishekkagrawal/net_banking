 ...
 * 
 */
public class TransactionPasswordChangePageAction extends ActionSupport
	...
	public void setConformNewTransactionPassword(
			String conformNewTransactionPassword) {
	...
	public String execute() {
		...
		if (loginInfoBean == null) {
			...
			result = delegate.changeTransactionPassword(loginInfoBean1,
