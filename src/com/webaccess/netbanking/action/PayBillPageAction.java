...
public class PayBillPageAction extends ActionSupport implements SessionAware {
	...
	public void setElectricityBillTransactionPassword(
			String electricityBillTransactionPassword) {
	...
	public void setBSNLCelloneTransactionPassword(
			String BSNLCelloneTransactionPassword) {
	...
	// forwarding to modify bill page with electric ,bsnlcellone and sbi lifr
	// insurece list
	...
	public String payElectricityBill() {
		...
		if (userInfoBean == null) {
			...
			loginInfoBean
					.setTransactionPassword(getElectricityBillTransactionPassword());
			...
			String result = billDelegate.payElectricityBill(
					electricityBillBean, loginInfoBean,
					getElectricityBillRemark());
	...
	public String payBSNLCelloneBill() {
		...
		if (userInfoBean == null) {
			...
			loginInfoBean
					.setTransactionPassword(getBSNLCelloneTransactionPassword());
			loginInfoBean.setAccountNumber(accountnumber);
			...
			String result = billDelegate.payBSNLCelloneBill(
					bSNLCelloneBillBean, loginInfoBean,
					getBsnlCelloneBillRemark());
			if (result.equals("success")) {
				return "success";
			}
			if (result.equals("transactionPasswordError")) {
	...
	public String paySBILifeInsurenceBill() {
		...
		if (userInfoBean == null) {
			...
			loginInfoBean
					.setTransactionPassword(getSBILifeTransactionPassword());
			loginInfoBean.setAccountNumber(accountnumber);
			...
			sBILifeInsurenceBean
					.setSbiLifeinsurenceId(getSbiLifeInsurenceBillId());
			String result = billDelegate.paySBILifeInsurenceBill(
					sBILifeInsurenceBean, loginInfoBean,
					getSbiLifeInsurenceBillRemark());
			if (result.equals("success")) {
				return "success";
			}
			if (result.equals("transactionPasswordError")) {
