 ...
 * @author Jay Prakash
 */
public class ApplyCreditCardAction extends ActionSupport implements
		SessionAware {
	...
	ArrayList<?> cardTypeList = new ArrayList<Object>();
	...
	public String execute() {
		...
		if (userInfoBean == null) {
			...
			int accountNumber = userInfoBean.getAccountNumber();
			String result = creditCardDelegate.applyNewCreditCard(
					accountNumber, cardTpe, nameOnCard);
