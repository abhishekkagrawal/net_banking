 ...
 * @author jay prakash
 */
public class RegisterBeneficiaryNEFTAction extends ActionSupport implements
		SessionAware, ModelDriven<BeneficiaryDetailBean> {
	...
	List<?> bankName = new ArrayList<Object>();
	...
	// forwarding to confirm and reject beneficiary page jsp with deactive
	// beneficiary
