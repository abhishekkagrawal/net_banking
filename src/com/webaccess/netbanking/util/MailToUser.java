...
public class MailToUser {
	...
	public void createEmailMessage(LoginInfoBean loginBean,
			UserInfoBean userBean) throws AddressException, MessagingException {
		setMailServerProperties();
		String[] toEmails = { userBean.getEmailId() };
		String emailBody = "";
		String emailSubject = "About Registration";
		if (loginBean.getLoginType().equals("View")) {
			emailBody = "Hi " + userBean.getName()
			...
			emailBody = "Hi " + userBean.getName()
					...
					+ "Your User Id :" + loginBean.getUserId()
					+ "<br/> Login Password:" + loginBean.getLoginPassword()
					+ "<br/> Transaction Password:"
					+ loginBean.getTransactionPassword();
		}
	...
	private void sendEmail() throws AddressException, MessagingException {
		...
		String fromUser = "jayprakash0701";// just the id alone without
											// @gmail.com
		String fromUserEmailPassword = "bettiahbihar";// enter your gmail
														// password
	...
	// sending opt number
	public int sendOPTNumber(String emailId) throws AddressException,
			MessagingException {
		setMailServerProperties();
		int optNumber = 0;
		...
		emailBody = "Hi <br/>" + "Your opt number :" + optNumber
	...
	// sending URN number
	public void sendURNNumber(String emailId, String messageBody)
		...
		emailBody = "Hi <br/>" + "Your URN number :" + messageBody
				+ "<br/> Please enter it into form";
	...
	public void sendTransactionDetail(String emailId, String messageBody)
			throws AddressException, MessagingException {
		setMailServerProperties();
		String[] toEmails = { emailId };
		String emailBody = "";
